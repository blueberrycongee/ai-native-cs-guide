...
教程文档应该像真正的教程：把主题讲到一个可用深度。读者读完后，应该对这个概念或工程实践本身有更深入的理解，而不是只知道“以后应该去学它”。
...
- 参考项目：哪些开源项目体现了这种做法，应该看哪个目录、模块或 example。
...
它不能只告诉读者“为什么要学”和“学到什么程度”。这些可以出现在路径页里，但不能成为概念页的主体。
